...
* [三、变量与数据类型](#三变量与数据类型)
   ...
   * [3.2、字符串](#32字符串)
   * [3.3、数组](#33数组)
   * [3.4、Any 和 Any?](#34any-和-any)
   * [3.5、Unit](#35unit)
   * [3.6、Nothing](#36nothing)
* [四、函数](#四函数)
   * [4.1、命名参数](#41命名参数)
   * [4.2、默认参数值](#42默认参数值)
   * [4.3、可变参数](#43可变参数)
   * [4.4、局部函数](#44局部函数)
* [五、表达式和条件循环](#五表达式和条件循环)
   * [5.1、语句和表达式](#51语句和表达式)
   * [5.2、If 表达式](#52if-表达式)
   * [5.3、when 表达式](#53when-表达式)
   * [5.4、for 循环](#54for-循环)
   * [5.5、while 和 do/while 循环](#55while-和-dowhile-循环)
   * [5.6、返回和跳转](#56返回和跳转)
* [六、区间](#六区间)
* [七、修饰符](#七修饰符)
   * [7.1、final 和  oepn](#71final-和--oepn)
   * [7.2、public](#72public)
   * [7.3、protected](#73protected)
   * [7.4、internal](#74internal)
   * [7.5、private](#75private)
   * [7.6、总结](#76总结)
* [八、空安全](#八空安全)
   * [8.1、可空性](#81可空性)
   * [8.2、安全调用运算符：?.](#82安全调用运算符)
   * [8.3、Elvis 运算符：?:](#83elvis-运算符)
   * [8.4、安全转换运算符：as?](#84安全转换运算符as)
   * [8.5、非空断言：!!](#85非空断言)
   * [8.6、可空类型的扩展](#86可空类型的扩展)
   * [8.7、平台类型](#87平台类型)
* [九、类型的检查与转换](#九类型的检查与转换)
   * [9.1、类型检查](#91类型检查)
   * [9.2、智能转换](#92智能转换)
   * [9.3、不安全的转换操作符](#93不安全的转换操作符)
   * [9.4、安全的转换操作符](#94安全的转换操作符)
* [十、类](#十类)
   * [10.1、基本概念](#101基本概念)
   * [10.2、主构造函数](#102主构造函数)
   * [10.3、次构造函数](#103次构造函数)
   * [10.4、属性](#104属性)
   * [10.5、自定义访问器](#105自定义访问器)
   * [10.6、延迟初始化](#106延迟初始化)
* [十一、类的分类](#十一类的分类)
   * [11.1、抽象类](#111抽象类)
   * [11.2、数据类](#112数据类)
   ...
   * [11.7、内部类](#117内部类)
* [十二、接口](#十二接口)
   * [12.1、抽象方法与默认方法](#121抽象方法与默认方法)
   * [12.2、抽象属性](#122抽象属性)
* [十三、继承](#十三继承)
   * [13.1、覆盖方法](#131覆盖方法)
   * [13.2、属性覆盖](#132属性覆盖)
   * [13.3、调用超类实现](#133调用超类实现)
* [十四、集合](#十四集合)
   * [14.1、只读集合与可变集合](#141只读集合与可变集合)
   * [14.2、集合与 Java](#142集合与-java)
   * [14.3、只读集合的可变性](#143只读集合的可变性)
   * [14.4、集合与可空性](#144集合与可空性)
